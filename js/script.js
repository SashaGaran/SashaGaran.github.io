...
ScrollReveal({ opacity: 0.0 });


ScrollReveal().reveal('.card-tag', { delay: 220, origin: 'top', scale: 1.0, distance: '10px', rotate: { x: 80, y: 0, z: 0}});

ScrollReveal().reveal('.smooth_scroll', { delay: 40, interval: 80 });
...
ScrollReveal().reveal('tr', { delay: 420, interval: 100 });
